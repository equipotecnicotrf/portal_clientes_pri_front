...
class ConsultOrderService {
    ...
    getOrdersByCustomer(buyingPartyId, transactionTypeCode, creationDateFrom, creationDateTo) {
        return axios.get(BASE_REST_API_URL + "/getOrdersLinesAndHeaders?buyingPartyId=" + buyingPartyId + "&transactionTypeCode=" + transactionTypeCode + "&creationDateFrom=" + creationDateFrom + "&creationDateTo=" + creationDateTo)
    }
